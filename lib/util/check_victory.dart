...
class CheckVictory {
  static Victory checkForVictory(List<List<String>> field, String playerChar) {
    ...
    if (field[0][0].isNotEmpty &&
        ...
        field[0][0] == field[0][2]) {
      v = Victory(
          0, 0, HORIZONTAL, field[0][0] == playerChar ? PLAYER : AI_PLAYER);
    } else if (field[1][0].isNotEmpty &&
        field[1][0] == field[1][1] &&
        field[1][0] == field[1][2]) {
      v = Victory(
          1, 0, HORIZONTAL, field[1][0] == playerChar ? PLAYER : AI_PLAYER);
    } else if (field[2][0].isNotEmpty &&
        field[2][0] == field[2][1] &&
        field[2][0] == field[2][2]) {
      v = Victory(
          2, 0, HORIZONTAL, field[2][0] == playerChar ? PLAYER : AI_PLAYER);
    }
    ...
    //check vertical lines
        ...
        field[0][0] == field[2][0]) {
      v = Victory(
          0, 0, VERTICAL, field[0][0] == playerChar ? PLAYER : AI_PLAYER);
    } else if (field[0][1].isNotEmpty &&
        field[0][1] == field[1][1] &&
        field[0][1] == field[2][1]) {
      v = Victory(
          0, 1, VERTICAL, field[0][1] == playerChar ? PLAYER : AI_PLAYER);
    } else if (field[0][2].isNotEmpty &&
        field[0][2] == field[1][2] &&
        field[0][2] == field[2][2]) {
      v = Victory(
          0, 2, VERTICAL, field[0][2] == playerChar ? PLAYER : AI_PLAYER);
    }
    ...
    //check diagonal
        ...
        field[0][0] == field[1][1] &&
        field[0][0] == field[2][2]) {
      v = Victory(0, 0, DIAGONAL_DESCENDING,
          field[0][0] == playerChar ? PLAYER : AI_PLAYER);
    } else if (field[2][0].isNotEmpty &&
        field[2][0] == field[1][1] &&
        field[2][0] == field[0][2]) {
      v = Victory(2, 0, DIAGONAL_ASCENDING,
          field[2][0] == playerChar ? PLAYER : AI_PLAYER);
    } else if (field[0][0].isNotEmpty &&
